...
train.AddAnimalToTrain(new Animal("Test2", AnimalSize.Large, AnimalDiet.Herbivore));
train.AddAnimalToTrain(new Animal("Test3", AnimalSize.Large, AnimalDiet.Herbivore));
train.AddAnimalToTrain(new Animal("Test4", AnimalSize.Medium,AnimalDiet.Herbivore));
train.AddAnimalToTrain(new Animal("Test5", AnimalSize.Medium, AnimalDiet.Herbivore));
train.AddAnimalToTrain(new Animal("Test6", AnimalSize.Medium, AnimalDiet.Herbivore));
...
// Sort animals and optimize placement in wagons
